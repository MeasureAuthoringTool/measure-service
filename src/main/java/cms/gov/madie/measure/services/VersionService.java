...
public class VersionService {
  ...
  private Measure applyMeasureVersion(
    ...
    actionLogService.logAction(
        ...
        username, String.format("Versioned to %s", upversionedMeasure.getVersion()));
    log.info(
  ...
  public Measure createDraft(
    ...
    actionLogService.logAction(savedDraft.getId(), Measure.class, ActionType.DRAFTED, username, String.format("Draft created from version %s", measure.getVersion()));
