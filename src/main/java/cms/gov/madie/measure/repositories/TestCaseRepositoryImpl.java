...
public class TestCaseRepositoryImpl implements TestCaseRepository {
  ...
  /**
   * Checks if any TestCase within an active Measure (identified by its measureSetId) has a
   * non-null testCaseSetId value.
   *
  ...
  public Measure findAndUpdateValidationResults(
    ...
    update.set("testCases.$.validationStatus", validationResultStatus);
    update.set(
        "testCases.$.validResource", validationResults != null && validationResults.isSuccessful());
