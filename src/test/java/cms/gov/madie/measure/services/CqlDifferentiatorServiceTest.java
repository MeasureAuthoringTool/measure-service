...
class CqlDifferentiatorServiceTest {
  ...
  void testCompareLibraries_withSimpleCql() {
    ...
    List<CqlFileComparison> result = service.compareLibraries(oldLibraries, newLibraries, true);

    assertNotNull(result);
    assertEquals(1, result.size());

    CqlFileComparison comparison = result.get(0);
  ...
  void testCompareLibraries_withoutReordering() {
    ...
    List<CqlFileComparison> result = service.compareLibraries(oldLibraries, newLibraries, false);
